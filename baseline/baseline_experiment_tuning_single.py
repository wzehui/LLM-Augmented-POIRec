...
EMBEDDING_PATHS = {
    ...
    # "product": "../yelp/embeddings/product_no_name_embeddings_openai.csv.gz",
    # "geo": "../yelp/embeddings/geo_embeddings_openai.csv.gz",
    # "geo": "../yelp/embeddings/geo_no_neighbor_embeddings_openai.csv.gz",
    # "review": "../yelp/embeddings/review_summary_embeddings_deepseek.csv.gz",
    # "review": "../yelp/embeddings/review_summary_no_rating_embeddings_deepseek.csv.gz",
    # "photo": "../yelp/embeddings/photo_summary_embeddings_openai.csv.gz",
    "photo": "../yelp/embeddings/photo_summary_no_attribute_embeddings_openai.csv.gz",
}

DATASET_PATHS = {
    "product": "../yelp/embeddings/openai_augmented_dataset_training.pickle",
    "geo": "../yelp/embeddings/openai_augmented_dataset_training_g.pickle",
    "review": "../yelp/embeddings/openai_augmented_dataset_training_r.pickle",
    "photo": "../yelp/embeddings/openai_augmented_dataset_training_p.pickle",
}
...
def objective(trial):
    if model_class.__name__ == "GRURecWithEmbeddings":
        llm2grurec_config = {
            ...
            "optimizer_kwargs": {
                "learning_rate": trial.suggest_float("learning_rate", 0.0005,
                                                     0.005, log=True),
...
for model_class in model_classes:
    for embedding_key in EMBEDDING_PATHS:
        ...
        OPTUNA_STUDY_FILE = os.path.join(EXPERIMENTS_FOLDER, f"{model_class.__name__}_optuna_study_{embedding_key}.pkl")
        ...
        csv_file_path = os.path.join(
            EXPERIMENTS_FOLDER,
            f"{model_class.__name__}-{embedding_key}_no_attribute_best_3_{timestamp}.csv"
        )
